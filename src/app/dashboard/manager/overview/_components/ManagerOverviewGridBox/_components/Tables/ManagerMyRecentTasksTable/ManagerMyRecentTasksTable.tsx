...
"use client";
import ManageTasksEditTaskForm from "@/app/dashboard/manager/(TaskManagement)/manage-tasks/_components/ManageTasksEditTaskForm/ManageTasksEditTaskForm";
import ManageTasksTaskDetails from "@/app/dashboard/manager/(TaskManagement)/manage-tasks/_components/ManageTasksTaskDetails/ManageTasksTaskDetails";
...
function ManagerMyRecentTasksTable() {
  ...
  return (
    <section className="w-full space-y-5">
      ...
      <div className="flex items-center justify-between gap-4">
        ...
        <Link href="/dashboard/manager/manage-tasks">
...
export default ManagerMyRecentTasksTable;
