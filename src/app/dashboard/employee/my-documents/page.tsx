// import EmployeeMyDocumentsTable from "./_components/EmployeeMyDocumentsTable/EmployeeMyDocumentsTable";

// function EmployeeMyDocumentsPage() {
//   return (
//     <section>
//       <EmployeeMyDocumentsTable />
//     </section>
//   );
// }
...
const EmployeeMyDocumentsPage = () => {
  ...
  return (
    <div className="space-y-5 p-2 md:p-6">
      {/* <Breadcrumb
        path={[]}
        onNavigate={() => router.push("/dashboard/employee/my-documents")}
      /> */}
      ...
      {isLoading ? (
        ...
        <FolderGrid
          ...
          onFolderClick={(folder) =>
            router.push(`/dashboard/employee/my-documents/${folder.id}`)
          }
