...
const schema = z.object({
    ...
    otp: z.string().min(1, "OTP is required").min(6, "OTP must be at least 6 digits"),
    newPassword: z
        .string()
...
const ChangePasswordForm = () => {
    ...
    const onSubmit = async (data: FormData) => {
        try {
            const res = (await resetPassword(data)) as any;
            if (res?.success) {
                toast.success(
        ...
        <section className="flex h-screen w-full items-center justify-center">
            ...
            <div className="w-full max-w-md rounded-2xl bg-white p-6 shadow-sm">
                ...
                <form onSubmit={handleSubmit(onSubmit)} className="mt-8 space-y-5">
                    ...
                    {/* OTP Field */}
                    <div>
                        <label htmlFor="otp" className="block text-sm text-slate-600 mb-2">OTP</label>
                        <input
                            id="otp"
                            type="text"
                    ...
                    <div className="mt-8">
                        ...
                        >
                            {isSubmitting ? <Loader2 className="w-4 h-4 mr-2 animate-spin" /> : "Reset Password"}
                        </button>
                    </div>
                </form>
            </div>
